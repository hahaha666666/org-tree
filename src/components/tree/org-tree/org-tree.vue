...
<script>
import {render,renderBtn} from './node.js'
export default {
  name: 'Vue2OrgTree',
  components: {
    OrgTreeNode: {
...
<style type='text/scss'  lang='scss' scoped>
  ...
  .addBtn{
    width: 15px;height:15px;background-color: red;display: inline-block;cursor: pointer;position: absolute;right:-20px;
    text-align: center;line-height: 13px;color:white;z-index: 100;
  }
